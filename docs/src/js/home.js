...
function initializeBookCarousel() {
    ...
    if (!track || !indicatorsContainer || !prevBtn || !nextBtn) return;
                    ...
                    <div class="book-info">
                        ...
                        <div class="book-meta-info">
                            ...
                            <div class="meta-item">
                                ...
                                <span class="meta-value status">${book.targetAudience || 'Adult & Young Adult'}</span>
                            </div>
                            <div class="meta-item">
                                <span class="meta-label">Point of View</span>
                                <span class="meta-value status">${book.pov}</span>
                            </div>
                            <div class="meta-item">
                        ...
                        <div class="book-actions">
                            ...
                            <a href="books/${book.slug}.html" class="btn btn-secondary">Learn More</a>
                        </div>
                    </div>
                </div>
            `;
    ...
    function renderIndicators() {
        indicatorsContainer.innerHTML = books.map((_, idx) => `
